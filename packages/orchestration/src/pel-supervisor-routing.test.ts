...
import { runResumeQueueExecution, QueueSubmitter } from './resume-queue-execution.js';
...
const config = { resumeMaxAttempts: 2, shellBinary: '/bin/sh', laneRunScript: '/unused', dryRun: false };
