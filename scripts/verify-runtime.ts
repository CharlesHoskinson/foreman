...
const trackedGraphEvaluationPath = join(
  trackedRuntime,
...
const trackedGraphEvaluation = readFileSync(trackedGraphEvaluationPath);
...
// 3. Negative manifest probes
{
  ...
  try {
    ...
    writeFileSync(
      join(rt, "dist/graph-evaluation.js"),
      trackedGraphEvaluation,
    );
