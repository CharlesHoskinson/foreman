...
- Product/runtime modules to migrate: **8**.
- Tracked Python files: **20**.
- Product and release Python files: **11**.
- Research, archive, and vendored Python files: **9**.
...
### Research and archive paths: 3 files
...
|---|---|---|
| 0 | Governance and immutable baseline | Iron Rule, OpenSpec, package matrix, stale-record purge, and Council plan review are complete. |
