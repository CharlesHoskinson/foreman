...
captured_at: "2026-09-13T03:01:35.276462+00:00"
...
The [`max_output_tokens`](/api/interactions-api#request-body) generation
...
**Note:** Because `max_output_tokens` applies to the combined total of thinking
tokens and output tokens, setting a low limit can truncate responses. See
[Token limits and `max_output_tokens`](#token-limits) for details.
