...
- [x] **1. `skills/foreman/templates/captured-facts.md`** — the artifact
  ...
  cite its probe.
- [x] **2. `skills/foreman/references/captured-facts.md`** — doctrine:
...
- [x] **3. `five-part-spec.md` note** — a spec derived from discovery MUST
